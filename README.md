...
5. دکمه طلایی **اجرا** — گام ۱ ضابطهٔ **ملک** (روکش Zabeteh). صلح برای همه ملک‌ها اجباری نیست؛ اگر صلح نداشت گام ۲ لازم نیست.
6. اگر روکش نبود گام ۱ رد می‌شود. اگر روکش بود و Active خالی بود یعنی این پرونده صلح ندارد — تحلیل را جدا ببینید. Member 1296 را عوض نکنید.
