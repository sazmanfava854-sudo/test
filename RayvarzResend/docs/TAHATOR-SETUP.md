...
### مسیر ۱۵۷ / مبلغ (GoldenFicheId 11–14)
...
### مسیر ۱۵۸ / درآمدی (GoldenFicheId 15+)

هنوز در SQL seed نشده — پس از export نمونه‌های `incmdocsys` برای فیش‌های گروه ۱۵۸ (DocTyp ۱۷/۱۸، Val مثبت، Branch منطقه، Center1=`335000181`) به همین فایل اضافه می‌شود.
